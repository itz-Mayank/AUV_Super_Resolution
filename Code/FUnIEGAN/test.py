...
# Input directory for low-resolution test images
parser.add_argument(
    "--data_dir",
    type=str,
    default="C:\\Users\\Mayank Meghwal\\Desktop\\Reserch Papers AUV\\AUV\\Code\\Data\\UFO-120\\TEST\\lrd\\"
)

# Output directory for GAN-enhanced images
parser.add_argument(
    "--sample_dir",
    type=str,
    default="C:\\Users\\Mayank Meghwal\\Desktop\\Reserch Papers AUV\\AUV\\Results\\GanEnhanced\\"
)
...
parser.add_argument(
    "--model_name",
    type=str,
    default="funiegan"  # or "ugan"
)

# Path to generator .pth model file
parser.add_argument(
    "--model_path",
    type=str,
    default="C:\\Users\\Mayank Meghwal\\Desktop\\Reserch Papers AUV\\AUV\\Code\\FUnIEGAN\\models\\funie_generator.pth"
)
...
if opt.model_name.lower() == 'funiegan':
    ...
    raise ValueError("Unknown model name: choose 'funie' or 'ugan'")
